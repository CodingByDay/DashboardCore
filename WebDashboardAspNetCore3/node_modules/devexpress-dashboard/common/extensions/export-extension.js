...
var DashboardExportExtension = (function () {
    function DashboardExportExtension(dashboardControl, options) {
        ...
        this._dialogBinder = new _export_dialog_binder_1.ExportDialogBinder(dashboardControl.dashboard, dashboardControl._serviceClient, function () { return _dashboard_layout_mode_helper_1.DashboardLayoutModeHelper.isMobile ? window.document.body : dashboardControl.getWidgetContainer(); }, options, this._exportInfoContoller);
