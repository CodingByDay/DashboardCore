...
var DateFilterItem = (function (_super) {
    ...
    DateFilterItem.prototype._removeSelectionFromState = function (state) {
        var itemState = _super.prototype._removeSelectionFromState.call(this, _utils_2.deepExtend({}, state));
    ...
    DateFilterItem.prototype._setPredefinedPeriodToState = function (state, periodName) {
        var itemState = _super.prototype._setPredefinedPeriodToState.call(this, _utils_2.deepExtend({}, state), periodName);
