...
var TextBoxItemSurface = (function (_super) {
    ...
    TextBoxItemSurface.prototype.fillSections = function () {
        var _this = this;
        this.sections.push(new _data_item_collection_surface_1.DataItemCollectionSurface(this, _section_descriptors_1.SectionDescriptors.Values, function (tabs, model) { return _this.extendTabsHandler && _this.extendTabsHandler(tabs, model, _this.dashboardItem); }));
    };
