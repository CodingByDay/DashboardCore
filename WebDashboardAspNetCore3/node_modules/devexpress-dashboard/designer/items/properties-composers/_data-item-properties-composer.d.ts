...
export declare class DataItemsPropertiesComposer implements IDetailsPropertiesComposer<DataItemLink> {
    ...
    static getFormatRulesForDataItemWrapper(model: DataDashboardItem, dataItem: DataItem, dataItemApplyTo: DataItem, formatRuleItemType: string, dataSourceBrowser: DataSourceBrowser, editHandler: any): ObjectPropertiesWrapper<DataDashboardItem>;
}
