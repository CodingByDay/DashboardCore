...
var FormatRulePropertiesComposer = (function () {
    ...
    FormatRulePropertiesComposer.prototype.fillMiscWrapper = function (tab, model, dashboardItem, dataSourceBrowser) {
        ...
        if (model instanceof pivot_item_format_rule_1.PivotItemFormatRule) {
            ...
            var isMeasure_1 = !!pivot.values().filter(function (v) { return v.uniqueName() === model.dataItemApplyToName(); }).length;
            visibilityRules[_cells_item_format_rule_1.applyToRow.propertyName] = function (m) { return !model.condition()._isApplyToRowColumnRestricted && isMeasure_1; };
            visibilityRules[_pivot_item_format_rule_1.applyToColumn.propertyName] = function (m) { return !model.condition()._isApplyToRowColumnRestricted && isMeasure_1; };
            ...
            p.push(_cells_item_format_rule_1.applyToRow);
            visibilityRules[_cells_item_format_rule_1.applyToRow.propertyName] = function (m) { return !model.condition()._isApplyToRowColumnRestricted; };
        }
        var wrapper = new _object_properties_wrapper_1.ObjectPropertiesWrapper({
            model: model,
            properties: p,
