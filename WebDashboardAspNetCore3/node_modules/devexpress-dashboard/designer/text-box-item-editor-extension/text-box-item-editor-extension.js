...
var index_internal_2 = require("../../model/index.internal");
var index_internal_3 = require("../../common/index.internal");
...
var TextBoxItemEditorExtension = (function (_super) {
    ...
    TextBoxItemEditorExtension.prototype.start = function () {
        ...
        if (contextMenuExtension && propertiesPanelExtension) {
            this.toDispose(index_internal_2.subscribeAndPerform(contextMenuExtension._itemContextMenu, function (menu) {
                if (menu) {
                    var detailData = menu.contextMenuItems()[0].detailData;
                    if (detailData instanceof _textbox_item_surface_1.TextBoxItemSurface) {
                        detailData.extendTabsHandler = function (tabs, model, dashboardItem) {
                            ...
                            tabs.push(new _accordion_tab_1.ContentInHeaderAccordionTab("text-box-item-rich-edit", index_internal_1.getLocalizationById("DashboardWebStringId.AccordionTab.Content"), new _object_properties_wrapper_1.ObjectPropertiesWrapper({
                                model: dashboardItem,
                                properties: [
                                    textBoxTextProperty
                                ]
    ...
    TextBoxItemEditorExtension.prototype._extendTextBoxSerializationInfo = function (textProperty, textBoxDashoardItem, dataSourceBrowser) {
        var _this = this;
        textProperty.displayName = index_internal_1.getLocalizationById("DashboardWebStringId.AccordionTab.Content");
        textProperty.editor = _base_metadata_1.editorTemplates.customEditor;
        textProperty.renderEditor = function (element, options) {
            new button_1.default(element, {
                text: index_internal_1.getLocalizationById("DashboardWebStringId.TextBoxItemEditor.EditTextButton"),
                width: '100%',
                onClick: function () {
                    ...
                    _this._viewModel.show(options, docVariables, _this._getDashboardItemWidth());
                }
            });
        };
    };
    TextBoxItemEditorExtension.prototype._getDashboardItemWidth = function () {
        ...
        if (dashboardSurface && dashboardSurface._selectedLayoutItem()) {
            return dashboardSurface._selectedLayoutItem().width() - index_internal_3.SplitterSize;
        }
        return null;
    };
