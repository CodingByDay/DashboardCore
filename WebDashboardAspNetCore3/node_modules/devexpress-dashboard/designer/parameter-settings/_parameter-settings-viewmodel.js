...
var _lookup_values_select_box_options_1 = require("./_lookup-values-select-box-options");
...
var ParameterEditorViewModel = (function (_super) {
    ...
    function ParameterEditorViewModel(dashboard, _dataSourceBrowserGetter) {
        ...
        _this.getLookupDefaultValuesSelectBoxOptions = function (parameter, container) { return new _lookup_values_select_box_options_1.LookupDefaultValuesSelectBoxOptions(parameter, _this.dataSourceBrowser, container); };
        _this.getLookupDefaultValueSelectBoxOptions = function (parameter, container) { return new _lookup_values_select_box_options_1.LookupDefaultValueSelectBoxOptions(parameter, _this.dataSourceBrowser, container); };
