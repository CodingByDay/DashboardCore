...
import { ContainerSelectorAccordionTabModel } from './items/container-type-selector/_container-type-selector';
...
export declare class ContentInHeaderAccordionTab extends AccordionTab {
    ...
    headerTemplate: string;
    hasNoBorder: boolean;
    onTitleClick: (tabModel: ContainerSelectorAccordionTabModel, data: any, event: any) => boolean;
}
export declare class TypeAccordionTab extends AccordionTab {
    tabModel: ko.Observable<ObjectPropertiesWrapper<ContainerSelectorAccordionTabModel>>;
    orderNo: number;
    style: string;
    headerTemplate: string;
    hasNoBorder: boolean;
    onTitleClick: (tabModel: ContainerSelectorAccordionTabModel, data: any, event: any) => void;
}
