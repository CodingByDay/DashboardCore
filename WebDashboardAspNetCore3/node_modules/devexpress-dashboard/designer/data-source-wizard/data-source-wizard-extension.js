...
var DataSourceWizardExtension = (function () {
    ...
    DataSourceWizardExtension.prototype.createDataSourceWizard = function (connectionStrings) {
        var wizard = _edit_query_wizard_1.createDashboardQueryWizard(this._requestWrapper, this._dashboardParameters, !this.isCustomSqlEnabled, this._options.allowCreateNewJsonConnection || this._options["canCreateNewJsonDataSource"], this._options.wizardSettings, connectionStrings);
        if (this._options.onCustomizeDataSourceWizard)
            this._options.onCustomizeDataSourceWizard({
...
var MultiQueryDataSourceWizardExtension = (function (_super) {
    ...
    MultiQueryDataSourceWizardExtension.prototype.createDataSourceWizard = function (connectionStrings) {
        var wizard = _multi_query_data_source_wizard_1.createDashboardMultiQueryWizard(this._requestWrapper, this._dashboardParameters, !this.isCustomSqlEnabled, this._options.allowCreateNewJsonConnection || this._options["canCreateNewJsonDataSource"], this._options.wizardSettings, connectionStrings);
        if (this._options.onCustomizeDataSourceWizard)
            this._options.onCustomizeDataSourceWizard({
