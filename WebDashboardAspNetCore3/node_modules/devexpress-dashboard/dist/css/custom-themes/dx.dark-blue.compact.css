...
.dx-scrollable-customizable-scrollbars .dx-scrollable-container::-webkit-scrollbar-button:horizontal:decrement {
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAMCAQAAADrXgSlAAAAKUlEQVQY02P4zwCD932RmPeRmfeRmfeRmfeRmegcFGVoBqAZjWYphAsAStVj99j7/WMAAAAASUVORK5CYII=) center no-repeat;
}
.dx-scrollable-customizable-scrollbars .dx-scrollable-container::-webkit-scrollbar-button:horizontal:increment {
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAMCAQAAADrXgSlAAAALUlEQVQY02O47/ufAQYZ7v9HcEEcOBfCgXJhHDAXwQFycXB8sRrgi9VSJOcAAMTJY/eJQvZcAAAAAElFTkSuQmCC) center no-repeat;
}
.dx-scrollable-customizable-scrollbars .dx-scrollable-container::-webkit-scrollbar-button:vertical:decrement {
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAGCAQAAABd57cKAAAAKUlEQVQYV2P4zwCD933v+yJ4yML/gRAuhSqMJIUuDJfCFIZKYRMGSwEAYXZj99VJzp4AAAAASUVORK5CYII=) 3px 5px no-repeat;
}
.dx-scrollable-customizable-scrollbars .dx-scrollable-container::-webkit-scrollbar-button:vertical:increment {
  background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAwAAAAGCAQAAABd57cKAAAAMklEQVQYV2O473v/Pxboy/CfAYuU738GoASGlC9IDCyBIgUWhkvApaDCSBJgKbjwfwYAVjpj95dOQnAAAAAASUVORK5CYII=) 3px 5px no-repeat;
}
...
.dx-tabpanel.dx-state-focused .dx-tabs-scrollable .dx-tab:not(.dx-tab-selected):before {
  ...
  z-index: 2;
  height: 0;
  border-bottom: 1.5px solid #579add;
  bottom: -1.4px;
}
...
.dx-gantt .dx-gantt-milestone {
  background-image: linear-gradient(135deg,#4d4d4d,#dedede);
  width: 12px;
  height: 12px;
}
